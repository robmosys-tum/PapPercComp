...
int main(int argc, char* argv[])
{
  ...
  std::string planner1_action_name = nh_priv.param<std::string>("planner1_action_name", "planner1");
  std::string planner2_action_name = nh_priv.param<std::string>("planner2_action_name", "planner2");
